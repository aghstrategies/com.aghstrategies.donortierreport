...
function _donortierreport_civix_civicrm_managed(&$entities) {
  ...
  foreach ($mgdFiles as $file) {
    ...
    foreach ($es as $e) {
      if (empty($e['module'])) {
        $e['module'] = 'com.aghstrategies.donortierreport';
      }
      $entities[] = $e;
    }
  }
...
function _donortierreport_civix_civicrm_caseTypes(&$caseTypes) {
  ...
  foreach (_donortierreport_civix_glob(__DIR__ . '/xml/case/*.xml') as $file) {
    ...
    $caseTypes[$name] = array(
      'module' => 'com.aghstrategies.donortierreport',
      'name' => $name,
      'file' => $file,
    );
  }
 ...
 */
function _donortierreport_civix_insert_navigation_menu(&$menu, $path, $item, $parentId = NULL) {
  static $navId;
  ...
  if (empty($path)) {
    ...
    foreach ($menu as $key => &$entry) {
      if ($entry['attributes']['name'] == $first) {
        ...
        $found = _donortierreport_civix_insert_navigation_menu($entry['child'], implode('/', $path), $item, $key);
      }
    }
    return $found;
  }
